...
public class MessageAdapter extends RecyclerView.Adapter<com.example.manishauth.MessageToAll.MessageAdapter.UserViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.manishauth.MessageToAll.MessageAdapter.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mCtx).inflate(R.layout.messages_layout, parent, false);
        return new com.example.manishauth.MessageToAll.MessageAdapter.UserViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.manishauth.MessageToAll.MessageAdapter.UserViewHolder holder, int position) {
