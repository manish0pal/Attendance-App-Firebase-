...
public class Stdmeeting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedbackbtn = findViewById(R.id.floatingbtn);
        ...
        feedbackbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Stdmeeting.this,AboutActivity.class));
            }
        });
    ...
    public void onBackPressed() {
        startActivity(new Intent(Stdmeeting.this, UserActivity.class));
        finish();
    }
    }
